...
Browse [open issues](https://github.com/lee-dohm/atom-theme-preview/issues) to see current requests.

[Open an issue](https://github.com/lee-dohm/atom-theme-preview/issues/new) to tell us about a bug. You may also open a pull request to propose specific changes, but it's always OK to start with an issue.
